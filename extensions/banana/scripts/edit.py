...
def main():
    ...
    parser.add_argument("--allow-paid", action="store_true", help="Explicit image-provider spend authority")
    args = parser.parse_args()
    if not args.allow_paid:
        parser.error("--allow-paid is required before a paid generation request")
