...
```bash
python3 ${SEO_ROOT}/extensions/banana/scripts/presets.py list
```
...
- Log every generation: `python3 ${SEO_ROOT}/extensions/banana/scripts/cost_tracker.py log --model MODEL --resolution RES --prompt "brief"`
...
| MCP unavailable | Fall back: `python3 ${SEO_ROOT}/extensions/banana/scripts/generate.py --prompt "..." --aspect-ratio "16:9"` |
