...
This manual governs mixed/full SEO work. The public `SKILL.md` remains the thin router. The calling agent or the standalone runner owns work scheduling, authority and delivery state. No external agent framework is required.
...
9. For authorized changes, capture baseline/hypothesis/evaluation conditions, execute through the configured standalone execution adapter, verify deployment, then measure outcome later.
...
SEO historically absorbed AgriciDaniel/claude-seo. As of upstream v2.3.1 (2026-09-10), the useful newer concepts incorporated into SEO are:
